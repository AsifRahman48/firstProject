                            ...
                            <table class="table table table-bordered table-striped table-hover bootstrap-data-table">
                                ...
                                @foreach($data['backups'] as $key => $backup)
                                    <tr>
                                        ...
                                        <td>{{ $backup->size }}</td>
                                        <td>
                                            <a href="{{ url('/') }}/storage/db_backup/{{ $backup->path }}" class="btn btn-sm btn-info"><i class="fa fa-cloud-download" aria-hidden="true"></i> Download</a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
    ...
    <script>
        ...
        $('#form-submit').on('submit', function (event) {
            ...
            $.ajax({
                ...
                url: "{{ route('scheduler.dbbackup.post') }}",
                beforeSend: function () {
