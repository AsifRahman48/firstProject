            ...
            <div class="login-content">
                <div class="login-logo">
                    @if(\Illuminate\Support\Facades\Storage::disk('public')->has('setting/logo.png'))
                        <img class="mb-4" src="{{asset('storage/setting/logo.png')}}" alt="Logo" style="width: 180px">
                    @else
                        <img class="mb-4" src="{{ asset('ElaAdmin/images/logo.png') }}" alt="Logo" style="width: 180px">
                    @endif
                    <br>
                    <a class="clientName" href="{{ url('/') }}" style="font-size: 30px;">
