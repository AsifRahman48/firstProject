...
<aside id="left-panel" class="left-panel">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown {{ $manageShow_1 }}">
                    ...
                    <ul class="sub-menu children dropdown-menu {{ $manageShow_1 }}">
                        ...
                        echo DB::table('tickets')->where('tStatus', '=', 2)->where('initiator_id', '=',Auth::id())->count();
                             @endphp
                         </span></a></li>
                        ...
                        <li @if($mthd =='request_info') class="active" @endif><i class="fa fa-id-card-o"></i><a href="{{ url('request/request_info') }}">Request for Info
                            <span class="badge bg-secondary text-light br-5 rounded-circle"> @php
                        echo DB::table('tickets')->where('tStatus', '=', 9)->Where('now_ticket_at','=',Auth::id())->count();
                             @endphp</span>
                        </a></li>
 ...
 <li class="menu-item-has-children dropdown {{ $manageShow }}">
  ...
  <li @if($ctrl =='companyName') class="active" @endif><i class="menu-icon fa fa-angle-double-right"></i><a href="{{ url('company/list') }}">Company Name
                        ...
                        <li @if($ctrl =='category') class="active" @endif><i class="menu-icon fa fa-angle-double-right"></i><a href="{{ url('category') }}">Department
                         <span class="badge bg-secondary text-light br-5 rounded-circle">
                             @php
                        ...
                        <li @if($ctrl =='sub_category') class="active" @endif><i class="menu-icon fa fa-angle-double-right"></i><a href="{{ url('sub-category') }}">Unit/Section
                         <span class="badge bg-secondary text-light br-5 rounded-circle">
                                 @php
                        ...
                        <li @if($ctrl =='user') class="active" @endif><i class="menu-icon fa fa-angle-double-right"></i><a href="{{ url('users') }}">Users
                             <span class="badge bg-secondary text-light br-5 rounded-circle">
                                    @php
  ...
  <li @if($mthd =='LocalArchive') class="active" @endif><i class="menu-icon fa fa-angle-double-right"></i><a href="{{ url('archive/index') }}">Local to Archive
                         <span class="badge bg-secondary text-light br-5 rounded-circle">
                              @php
                        echo DB::table('tickets')->where('tStatus', '=', 4)->where('initiator_id', '=',Auth::id())->count();
                             @endphp
  ...
  <li @if($mthd =='ArchiveReport') class="active" @endif><i class="menu-icon fa fa-angle-double-right"></i><a href="{{ url('archive/archive_search') }}">Archive Search
