                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li><a href="{{ url("category") }}">Unit/Section List</a></li>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong>Update</strong> Unit/Section
                        </div>
                        <div class="card-body card-block">
                            ...
                            {!! Form::model($data['editData'], array('route' => array('sub-category.update', $data['editData']->id), 'method' => 'PUT', 'class'=>'form-horizontal', 'role'=>'form', 'name'=>'subCategoryUpdatePost', 'enctype'=>'multipart/form-data')) !!}
                                <div class="row form-group ">
                                    ...
                                    <!-- <div class="col-12 col-md-10"> -->
                                        {!! Form::select('cat_id', $data['catList'], null, ['class' => 'form-control custom-select  col-md-8', 'required' => 'required']) !!}
                                ...
                                <div class="row form-group">
                                    ...
                                    <!-- </div> -->
                                    <!-- <div class="col-12 col-md-10"> -->
                                        {!! Form::text('name', null, ['class' => 'form-control  col-md-8', 'placeholder' => 'Unit/Section name', 'required' => 'required']) !!}
