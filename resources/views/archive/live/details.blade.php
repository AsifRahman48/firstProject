...
cursor: pointer;
 ...
 <a href="{{ url('/pdf/'.$data['TicketInfo']->id) }}" class="btn  btn-sm  pull-right text-danger" style="border: 1px #000 solid"> <i  class="fa fa-file-pdf-o fa-2x" aria-hidden="true"></i></a>
                         <a href="{{ url('/pdf/'.$data['TicketInfo']->id.'?type=L') }}" class="btn text-danger btn-sm  pull-right" style="margin-right: 10px; border: 1px #000 solid ; font-size: 20px; font-weight: 2000; font-style: bold">  <b>L</b> </a>

                         
                   <!--    <a href="{{ url('/pdf/'.$data['TicketInfo']->id) }}" class="btn btn-secondary btn-sm  pull-right"> <i  class="fa fa-file-pdf-o fa-2x" aria-hidden="true"></i></a> -->
                        </div>
