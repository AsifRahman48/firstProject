  ...
  <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
    <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Live Data Search </strong>
                            </div>
                            <div class="card-body">
                                <div id="pay-invoice">
                                    <div class="card-body">
                                                ...
                                                <div class="col-md-6 ">
                                                    <div class="form-group d-flex">
                                                       {!! Html::decode(Form::label('Start Date', 'Start Date', ['class' => 'form-control-label col-md-4'])) !!}
                                                        <input id="start_date" name="start_date" type="text" class="form-control datepicker col-md-8" placeholder="Start Date" autocomplete="off">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group d-flex">
                                                       {!! Html::decode(Form::label('End Date', 'End Date', ['class' => 'form-control-label col-md-4'])) !!}
                                                        <input id="end_date" name="end_date" type="text" class="form-control datepicker col-md-8" value="" autocomplete="off" placeholder="End Date">
                                                        <span class="help-block" data-valmsg-for="cc-exp" data-valmsg-replace="true"></span>
                                                    </div>
                                                </div>                                          
                                            </div>
                                        ...
                                        @endif
                                             ...
                                             <option selected="selected" value="">Select Unit/Section first...</option>
                                                     </select>
                                                    </div>
                                                </div>                                        
                                ...
                                <div class="row">
                                         <!--    <div class="col-md-4">
                                                ...
                                                <div class="col-md-6">
                                                 ...
                                                 <button id="payment-button" type="submit" class="btn btn-md btn-info pull-right" name="search">
