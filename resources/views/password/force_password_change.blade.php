                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li><a href="{{ route("force.password_change.index") }}">{{ $data['pageTitle'] }}</a></li>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body card-block ">
                            <div class="mx-auto">
                                ...
                                {!! Form::open(['url'=> route('force.password_change.store'), 'class'=>'form-horizontal', 'role'=>'form', 'enctype'=>'multipart/form-data']) !!}
                                <div class="row form-group">
                                    <div class="col-12 col-md-12 d-md-flex">
                                        {!! Html::decode(Form::label('password', 'New Password <span class="mandatory-field">*</span>', ['class' => 'form-control-label col-12 col-md-3' ])) !!}

                                        <div class="col-12 col-md-9 field">
                                ...
                                <div class="row form-group">
                                    <div class="col-12 col-md-12 d-md-flex">
                                        {!! Html::decode(Form::label('password_confirmation', 'Confirm Password <span class="mandatory-field">*</span>', ['class' => 'form-control-label col-12 col-md-3' ])) !!}
