...
<div class="col-md-12" style="padding: 0px;">
    ...
    <div class="card">
        <div class="card-header">
            <strong class="card-title">Audit Report</strong>
        </div>
        <div class="card-body">
            <div id="pay-invoice">
                <div class="card-body">
                        ...
                        <div class="row" style="margin-bottom: 10px;">
                            ...
                            <div class="col-md-6 mt-1">
                                <div class="form-group d-flex">
                                    ...
                                    <input id="reference_no" name="reference_no" type="text" class="form-control col-md-8 mt-1" placeholder="Reference No / Ticket ID">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group d-flex">
                                    {!! Html::decode(Form::label('Recommend/Approved By', 'Recommend/Approved By', ['class' => 'form-control-label col-md-4'])) !!}
                                    <select id="approved_by" name="approved_by" class="form-control select2" required>
                                        <option value="">Recommend/Approved By</option>
                                    </select>
                                </div>
                            </div>

                            <div class="col-md-12">
                                <input type="radio" value="3" class="custom-control-input" id="defaultInline2" name="searchType" >
...
<script>
    radiobtn = document.getElementById("defaultInline2");
    ...
    $(document).ready(function(){
        $("form#searchData").submit(function(event) {
            ...
            var approved_by = $('#approved_by').find(':selected').val();

            $.ajax({
                url: "{{ URL::to('/report_search')}}",
                type: "POST",
                data:  {"_token":meta ,"start_date":start_date,"end_date":end_date,"cat_id":cat_id,"sub_cat_id":sub_cat_id,"status":status,"company_id":company_id,"textSerch":textSerch,"reference_no" : reference_no, "searchType":searchType, "approved_by": approved_by, "initiated_by": initiated_by},
                beforeSend: function(){
                    $('#loader').show();
