                                 ...
                                 <div class="row" style="margin-bottom: 10px;">
                                               <div class="col-md-6 col-sm-12" style="display: none">     
                                                <div class="form-group d-flex">
                                                         ...
                                                         {!! Form::select('status', ['2'=>'Pending','4'=>'Approved','5'=>'Rejected','6'=>'Request Info'], old('status'), ['placeholder' => 'Select Status', 'class' => 'form-control col-md-8 custom-select','id'=>'status']) !!}
                                    ...
                                    <!-- <div class="col-md-8"> -->
                                       ...
                                       <!--  <div class="custom-control custom-radio custom-control-inline">
                                          <input type="radio" value="1" class="custom-control-input" id="defaultInline1" name="searchType">
