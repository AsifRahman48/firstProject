                ...
                <div class="card-body">
                    ...
                    <form id="searchData"  method="post" novalidate="novalidate">
                        ...
                        <div class="row" style="margin-bottom: 10px;">
                            <div class="col-md-6 col-sm-12 ">
                                <div class="form-group d-flex">
                                    ...
                                    {!! Form::select('cat_id', $data['departmentList'], old('cat_id'), ['id' => 'select_cat', 'placeholder' => 'Select Department', 'class' => 'form-control custom-select col-md-8', 'required' => 'required']) !!}
                        ...
                        <div class="row" style="margin-bottom: 10px;">
                            ...
                            <div class="col-md-12">
                                <input type="radio" value="4" class="custom-control-input" id="defaultInline2" name="searchType" >
    ...
    $(document).ready(function(){
        $("form#searchData").submit(function(event) {
            ...
            $.ajax({
                ...
                type: "POST",
                data:  {"_token":meta ,"start_date":start_date,"end_date":end_date,"cat_id":cat_id,"sub_cat_id":sub_cat_id,"status":status,"company_id":company_id,"textSerch":textSerch,"reference_no" : reference_no, "searchType":searchType},
                beforeSend: function(){
                    $('#loader').show();
