                    ...
                    <div class="card">
                        ...
                        <div class="card-body card-block ">
                            <div class="com-md-8  mx-auto">
                                ...
                                {!! Form::open(['route' => 'vacations.store', 'class' => 'form-horizontal']) !!}
                                <div class="row form-group">
                                    <div class="col col-md-12 d-flex">
                                        ...
                                        {!! Form::select('leave_type_id', $data['leaves'], null, [
                                ...
                                <div class="row form-group reason" style="display:none">
                                    <div class="col col-md-12 d-flex">
                                        ...
                                        {!! Form::text('reason', null, ['class' => 'form-control col-md-8', 'placeholder' => 'Reason']) !!}
                                    </div>
                                ...
                                <div class="row form-group">
                                    <div class="col col-md-11 d-flex">
                                        ...
                                        {!! Form::select('forward_user_id', [], null, ['class' => 'form-control col-md-7 select2', 'placeholder' => 'Select User']) !!}
                                    </div>
                                ...
                                <div class="row form-group">
                                    <div class="col col-md-12 d-flex">
                                        ...
                                        {!! Form::text('from_date', old('from_date'), ['class' => 'form-control col-md-8 datepicker', 'placeholder' => 'From Date', 'required' => 'required']) !!}
                                ...
                                <div class="row form-group">
                                    <div class="col-12 col-md-12  d-flex">
                                        ...
                                        {!! Form::text('to_date', old('to_date'), ['class' => 'form-control col-md-8 datepicker', 'placeholder' => 'To Date']) !!}
